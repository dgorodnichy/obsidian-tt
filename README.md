...
Данные хранятся в `plugin.saveData()` — в файле `.obsidian/plugins/obsidian-time-tracker/data.json`.

**Obsidian Sync**: чтобы синхронизировать записи между устройствами, включи:
`Настройки → Синхронизация → Дополнительно → Синхронизировать данные плагинов`
